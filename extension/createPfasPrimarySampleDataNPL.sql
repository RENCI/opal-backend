CREATE VIEW opal_pfas_sample_data_npl AS
SELECT sa.id AS id,
       ...
       sf.superfund_ogc_fid AS superfund_ogc_fid,
       sf.miles_to_closest_superfund_site AS miles_to_closest_superfund_site,
...
INNER JOIN opal_site_distance_to_closest_superfund_site sf ON sf.opal_id=sa.id;
